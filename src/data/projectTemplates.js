...
export const PROJECT_TEMPLATES = [
  // ---- Tier 1 - Startup / Freelance ----
  {
    ...
    requirements: [{ skill: SKILLS.BASIC_CODING, points: 100 }],
    payout: 1000,
    tier: 1,
  },
  {
    ...
    requirements: [
      { skill: SKILLS.BASIC_CODING, points: 140 },
  ...
  },
  {
    ...
    requirements: [
      { skill: SKILLS.BASIC_CODING, points: 100 },
      { skill: SKILLS.DATABASE_MANAGEMENT, points: 80 },
    ],
    payout: 2200,
    tier: 1,
  },
  {
    ...
    requirements: [
      { skill: SKILLS.BASIC_CODING, points: 120 },
  ...
  },
  {
    ...
    requirements: [
      { skill: SKILLS.BASIC_CODING, points: 80 },
  ...
  // ---- Tier 2 - Local Company ----
  {
    ...
    requirements: [
      ...
      { skill: SKILLS.BASIC_CODING, points: 150 },
      { skill: SKILLS.DATABASE_MANAGEMENT, points: 120 },
    ],
    payout: 5500,
    tier: 2,
  },
  {
    ...
    requirements: [
      ...
      { skill: SKILLS.DATABASE_MANAGEMENT, points: 200 },
      { skill: SKILLS.PROJECT_MANAGEMENT, points: 100 },
    ],
    payout: 7000,
    tier: 2,
  },
  {
    ...
    requirements: [
      ...
      { skill: SKILLS.DATABASE_MANAGEMENT, points: 160 },
      { skill: SKILLS.BASIC_CODING, points: 80 },
    ],
    payout: 5000,
    tier: 2,
  },
  {
    ...
    requirements: [
      ...
      { skill: SKILLS.BASIC_CODING, points: 140 },
      { skill: SKILLS.DATABASE_MANAGEMENT, points: 100 },
    ],
    payout: 4800,
    tier: 2,
  },
  ...
  // ---- Tier 3 - National ----
  {
    ...
    requirements: [
      ...
      { skill: SKILLS.DATABASE_MANAGEMENT, points: 300 },
      { skill: SKILLS.BASIC_CODING, points: 200 },
    ],
    payout: 25000,
    tier: 3,
  },
  {
    ...
    requirements: [
      ...
      { skill: SKILLS.DATABASE_MANAGEMENT, points: 400 },
      { skill: SKILLS.MOBILE_DEVELOPMENT, points: 250 },
      { skill: SKILLS.PROJECT_MANAGEMENT, points: 200 },
    ],
    payout: 28000,
    tier: 3,
  },
  {
    ...
    requirements: [
      { skill: SKILLS.BACKEND_DEVELOPMENT, points: 400 },
      { skill: SKILLS.DATABASE_MANAGEMENT, points: 350 },
  ...
  // ---- Tier 4 - Multinational ----
  {
    ...
    requirements: [
      ...
      { skill: SKILLS.DATABASE_MANAGEMENT, points: 600 },
      { skill: SKILLS.PROJECT_MANAGEMENT, points: 500 },
      { skill: SKILLS.BASIC_CODING, points: 300 },
    ],
    payout: 90000,
    tier: 4,
  },
