...
- **Low funds** warning if cash drops below $500 (but above $0)
...
- Up to **5** new projects are drawn based on office tier and unlocked research
- A template already running as an active project is excluded; completed templates can appear again

- **Hiring candidates** are fully replaced with up to **4** new candidates scaled to office tier
